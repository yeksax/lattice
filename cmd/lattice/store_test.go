...
func TestValidateConfigValue(t *testing.T) {
	tests := []struct {
		...
		{"theme.heading", "sans", true},
		{"theme.heading", "comic", false},
		{"theme.density", "spacious", true},
		{"theme.tone", "neutral", true},
		{"theme.tone", "olive", false},
		{"theme.dividers", "soft", true},
		{"theme.dividers", "thick", false},
		{"theme.modules", "cards", true},
		{"theme.modules", "tiles", false},
