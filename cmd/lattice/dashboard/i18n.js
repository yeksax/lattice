...
(() => {
  ...
  const en = {
    ...
    'reader.comment.threads.someone': 'someone',
    'reader.comment.threads.edited': 'edited',
    'reader.comment.threads.now': 'now',
    'reader.comment.threads.replies': { one: '{n} reply', other: '{n} replies' },
    ...
    'shared.stop.confirm': 'Confirm?',
    'shared.stopping': 'Stopping…',
    'shared.error.stop': 'Could not stop sharing',
    'shared.sort.aria': 'Sort shares by',
    'shared.sort.updated': 'Updated',
    'shared.sort.created': 'Published',
    'shared.filter': 'Access',
    'shared.filter.aria': 'Filter shares by access',
    'shared.filter.all': 'All',
    'shared.filter.public': 'Public',
    'shared.filter.domain': 'Restricted',
    'shared.filtered': 'No share matches this filter.',
    'shared.access': 'Access',
    'shared.access.public': 'Public link',
    'shared.more': 'More actions',
    'shared.history': 'Snapshot history',
    'shared.history.current': 'live',
    'shared.history.view': 'Preview',
    'shared.history.viewing': 'Previewing v{n}',
    'shared.history.back': 'Back to live',
    'shared.history.openTab': 'Open this revision in a new tab',
    'shared.history.none': 'Only one revision so far.',
    'shared.history.unsupported': 'This backend has no snapshot history yet — deploy the current Worker.',
    'shared.error.history': 'Could not load the history',
    'shared.version': 'v{n}',
    'shared.comments': { one: '{n} comment', other: '{n} comments' },
    'shared.threadsOpen': { one: '{n} open thread', other: '{n} open threads' },
    'shared.updated': 'updated {when}',
    'shared.updated.title': 'Snapshot published {when}',
    'shared.published.title': 'First shared {when}',
    'shared.drift': 'stale',
    'shared.drift.title': 'The file on disk changed after this snapshot was published.',
    'shared.orphan': 'not in library',
    'shared.republish': 'Update snapshot',
    'shared.republishing': 'Updating…',
    'shared.republished': 'Updated',
    'shared.error.republish': 'Could not update the snapshot',
    ...
    'share.lede.on.domain': 'Live, behind a Google sign-in. Only accounts on the domains below can open it.',
    'share.access': 'Access',
    'share.access.public': 'Anyone with the link',
    'share.access.restricted': 'Restricted to {d}',
    'share.domains.label': 'Restrict to domains (optional)',
    'share.domains.placeholder': 'acme.com, team.dev',
    'share.domains.hint': 'Comma-separated. Readers sign in with Google; anyone else gets a 403.',
    'share.access.save': 'Save access',
    'share.access.saving': 'Saving…',
    'share.access.saved': 'Saved',
    'share.access.republish': 'Saving re-uploads the file as it is on disk now.',
  ...
  const pt = {
    ...
    'reader.comment.threads.someone': 'alguém',
    'reader.comment.threads.edited': 'editado',
    'reader.comment.threads.now': 'agora',
    'reader.comment.threads.replies': { one: '{n} resposta', other: '{n} respostas' },
    ...
    'shared.stop.confirm': 'Confirmar?',
    'shared.stopping': 'Parando…',
    'shared.error.stop': 'Não foi possível parar o compartilhamento',
    'shared.sort.aria': 'Ordenar compartilhamentos por',
    'shared.sort.updated': 'Atualizado',
    'shared.sort.created': 'Publicado',
    'shared.filter': 'Acesso',
    'shared.filter.aria': 'Filtrar compartilhamentos por acesso',
    'shared.filter.all': 'Todos',
    'shared.filter.public': 'Público',
    'shared.filter.domain': 'Restrito',
    'shared.filtered': 'Nenhum compartilhamento nesse filtro.',
    'shared.access': 'Acesso',
    'shared.access.public': 'Link público',
    'shared.more': 'Mais ações',
    'shared.history': 'Histórico de snapshots',
    'shared.history.current': 'no ar',
    'shared.history.view': 'Prévia',
    'shared.history.viewing': 'Vendo a v{n}',
    'shared.history.back': 'Voltar para a atual',
    'shared.history.openTab': 'Abrir esta revisão em outra aba',
    'shared.history.none': 'Só existe uma revisão até agora.',
    'shared.history.unsupported': 'Este backend ainda não tem histórico de snapshots — publique o Worker atual.',
    'shared.error.history': 'Não foi possível carregar o histórico',
    'shared.version': 'v{n}',
    'shared.comments': { one: '{n} comentário', other: '{n} comentários' },
    'shared.threadsOpen': { one: '{n} discussão aberta', other: '{n} discussões abertas' },
    'shared.updated': 'atualizado {when}',
    'shared.updated.title': 'Snapshot publicado {when}',
    'shared.published.title': 'Compartilhado pela primeira vez em {when}',
    'shared.drift': 'desatualizado',
    'shared.drift.title': 'O arquivo no disco mudou depois que este snapshot foi publicado.',
    'shared.orphan': 'fora da biblioteca',
    'shared.republish': 'Atualizar snapshot',
    'shared.republishing': 'Atualizando…',
    'shared.republished': 'Atualizado',
    'shared.error.republish': 'Não foi possível atualizar o snapshot',
    ...
    'share.lede.on.domain': 'No ar, atrás de login Google. Só contas dos domínios abaixo conseguem abrir.',
    'share.access': 'Acesso',
    'share.access.public': 'Qualquer pessoa com o link',
    'share.access.restricted': 'Restrito a {d}',
    'share.domains.label': 'Restringir a domínios (opcional)',
    'share.domains.placeholder': 'acme.com, time.dev',
    'share.domains.hint': 'Separe por vírgula. Quem abre entra com Google; o resto recebe 403.',
    'share.access.save': 'Salvar acesso',
    'share.access.saving': 'Salvando…',
    'share.access.saved': 'Salvo',
    'share.access.republish': 'Salvar reenvia o arquivo como ele está no disco agora.',
